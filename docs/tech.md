...
|---|---|---|
| IaC | AWS SAM | Infrastructure as code, Lambda packaging and deployment |
...
- CDK adds unnecessary complexity for a Lambda-centric stack
- SAM's `template.yaml` is readable and self-contained
- No synthesis step or construct library management
...
| SAM CLI | Local Lambda testing and deployment |
